...
// testing condition
if(!$conn){
die("connection fail, ihangane usubire muri code!");
}
...
else
{
	echo "Failed to upload file";
		...
		echo"<li style='list-style-type: none; float:left; text-align: center;border: solid 2px black;width: 100px; background-color: green;'><a style='text-decoration: none; color: yellow' href='RejoTravelHomePage (2).html'>Retun to Home</a></li>";
