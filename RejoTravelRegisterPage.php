<?php
/* creating connections: server, user, password, and database*/
$s = "localhost";
$u = "root";
$p = "";
$db = "rejotravels_db";
...
$Mode_of_Payment = $_POST['Payment_mode'];
$Phone_number = $_POST['Phone_number'];
$Additional_notes = $_POST['Additional_Notes'];

// write MySQL querry that insert data in php_data
...
{
	echo "Your Ticket request submitted succesfully, our customers' departement will reach out to you in a while. Stay with your phone";
}
else
{
	echo "data not saved";
...
if (mysqli_num_rows($res_poi)) 
{
	while ($rows = mysqli_fetch_assoc($res_poi))
	{
		...
		echo"<li style='list-style-type: none; float:left; text-align: center;border: solid 2px black;width: 100px; background-color: green;'><a style='text-decoration: none; color: yellow' href='RejoTravelHomePage (2).html'>Home page</a></li>";
?>